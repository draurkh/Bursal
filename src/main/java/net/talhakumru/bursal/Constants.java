...
public class Constants {
	...
	public static final String CV_DIR = System.getProperty("user.home") + System.getProperty("file.separator")
			+ "cv_files";
	public static final String MONGO_CLUSTER_PASSWD = "Kue5kYqwpOrGkcE9";

	// approval state of scholarship application
	public enum State {
		UNDECIDED("Karar verilmedi.", "#ffad33"), APPROVED("Onaylandı.", "#00cc66"), DENIED("Reddedildi.", "#e60000");
